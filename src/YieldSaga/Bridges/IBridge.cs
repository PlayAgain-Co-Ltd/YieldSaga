...
///
/// 出処側 Runtime の <typeparamref name="TFromEffect"/> が EffectDispatcher に流れたとき、
/// <see cref="BridgeHandler{TFromEffect, TToInput, TFromState, TToState}"/> 経由で呼ばれ、
...
/// </summary>
public interface IBridge<in TFromEffect, out TToInput> where TFromEffect : Effect
{
